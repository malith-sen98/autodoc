...
export class SchedulebookComponent {
  ...
  ServiceStationIDfromSession:any;
  Allappointments:any;
  ...
  constructor(private _accountServiceVariable:AccountService,public dialog: MatDialog , private _stationServiceVariable:StationService ,private _bookingserviceVariable:BookingtestService) {}
  ...
  get_station_id(){
    ...
    .subscribe(
      data=> {this.ServiceStationIDfromSession = data[0].st_id;              
        console.log(this.ServiceStationIDfromSession,"user id ???????");
           this.getBaysDetails();
           this.getAllBookings();
           // this.get_selected_date_appointments(); // meka methanin ain kala uda functions call wela iwra nathi nisa.
      },
