...
export class ProfileComponent implements OnInit {
  ...
  constructor( private _bookingserviceVariable: BookingtestService , private _accountServiceVariable:AccountService, private _profileServiceVariable:ProfileService, public dialog: MatDialog) { }
