...
//7th page
  ...
  constructor(private _accountServiceVariable:AccountService, private _formBuilder: FormBuilder, private _bookingserviceVariable: BookingtestService,public dialog: MatDialog ,private router: Router ) { }
  ...
  ngOnInit(){
    ...
    // //get vehicles from database                                       // wnas krnwa
  ...
  get_user_id(){
    ...
    this._bookingserviceVariable.get_user_id( user_email )
    .subscribe(
      data=> {this.UserIdfromSession = data[0].owner_id;              
        console.log(data,"user id ???????");

        this.getOwner_details();
        this.getVehicleDetails();
        this.getServiceStationsByHomeTown();
      },
