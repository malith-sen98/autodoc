...
export class InventoryService {
  ...
  _url_inventory=environment.apiUrl+'/inv';
  _url_search=environment.apiUrl+'/search';
  // _url_addinventory='  http://localhost:3000/addinv';
  _url_addinventory=environment.apiUrl+'/addinv';
  _url_deleteinv = environment.apiUrl+'/deleteinv';
  _url_updateinv = environment.apiUrl+'/updateinv';
  _url_inv1 = environment.apiUrl+'/inv1';
