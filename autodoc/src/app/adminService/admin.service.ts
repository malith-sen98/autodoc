...
export class AdminService {
  ...
  _url_send_accpeted_declined_mail= 'http://localhost:3000/send_accpeted_declined_mail';
  _url_delete_station=  'http://localhost:3000/delete_station';
  _url_delete_owner = 'http://localhost:3000/delete_owner';
